...
async function runCandidateMatching() {
  ...
  // Define candidate matching criteria & weights
  const targetKeywords = [
    'ux', 'ui', 'product', 'design', 'graphic', 'visual', 'interface',
    'automation', 'ai', 'prototype', 'figma', 'framer', 'web'
  ];
